...
const COMPARISON_DATA: ComparisonRow[] = [
  { feature: "Процентная ставка", kmfc: "3,16%/мес (ГЭСВ до 46%)", banks: "от 18%/год", mfo: "от 5%/мес (60%/год)", note: "Ставки указаны в годовом исчислении для корректного сравнения" },
